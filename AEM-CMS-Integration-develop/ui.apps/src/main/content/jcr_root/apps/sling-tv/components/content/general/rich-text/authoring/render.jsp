...
%><div class="richtext-container">
    ...
    <div class="coral-RichText-editable coral-Form-field coral-Textfield coral-Textfield--multiline coral-RichText" data-config-path="/apps/sling-tv/components/content/general/rich-text/dialog/items/tab1/items/text.infinity.json"
